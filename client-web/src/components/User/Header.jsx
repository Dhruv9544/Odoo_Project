    ...
    return (
        loading && (
            <div className="bg-[#f8f9fa] font-family-karla flex ">
                <aside className="relative  bg-[#54a6d4] w-1/5  hidden sm:block shadow-xl shadow-gray-200 h-screen overflow-y-hidden ">
                ...
                <div className="w-full flex flex-col h-screen overflow-y-hidden ">
                    <header className="w-full items-center  bg-[#54a6d4] shadow-gray-900 shadow-md  py-2 px-6 hidden sm:flex">
